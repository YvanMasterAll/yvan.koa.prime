...
const enums = {
    ...
    permissions: [
        ...
        { id: 16, name: '权限查询', alias: 'PERMISSION_SELECT', pid: 15 },
        { id: 17, name: '权限创建', alias: 'PERMISSION_CREATE', pid: 15 },
        { id: 18, name: '权限编辑', alias: 'PERMISSION_EDIT', pid: 15 },
        { id: 19, name: '权限删除', alias: 'PERMISSION_DELETE', pid: 15 },
        { id: 20, name: '缓存管理', alias: 'REDIS_ALL', pid: 0 },
        { id: 21, name: '缓存查询', alias: 'REDIS_SELECT', pid: 20 },
        { id: 22, name: '缓存删除', alias: 'REDIS_DELETE', pid: 20 },
        ...
        { id: 59, name: '文件删除', alias: 'LOCALSTORAGE_DELETE', pid:  55 }
    ],
    menus: [
