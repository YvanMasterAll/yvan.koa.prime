...
function initData_Dept() {
    let data = [
        ...
        [1, '中正智控', 0], [4, '研发部', 0], [6, '财务部', 0], [7, '市场部', 0], [10, '人事部', 0]
    ]
...
function initData_Roles_Menus() {
    let data = [ 
        ...
        [2, 1], [2, 23], [2, 24], [2, 31], [2, 32], [2, 33], [2, 34], [3, 31], [3, 32], [3, 33], [3, 34]
    ]
...
function initData_Users() {
    let data = [
        [1, 'admin@zzzk.com', '123456', 'admin', 1, '18888888888', 1],
        [2, 'hr@zzzk.com', '123456', 'hr', 10, '18888888888', 3],
        [3, 'test@zzzk.com', '123456', 'test', 4, '18888888888', 6]
    ]
